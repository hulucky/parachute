...
//上传数据
public class JsdBean1 implements ISensorInf {
    ...
    public void caculate(byte[] bRec) {
        ...
        powerVel = MyFunc.twoBytesToInt(bRec,95);
        assiVel = MyFunc.HexToInt(MyFunc.Byte2Hex(bRec[97]));
    }
