...
public class PdfguideActivity extends AppCompatActivity implements OnPageChangeListener , OnLoadCompleteListener {
    ...
    private void display(String assetFileName) {
        ...
        pdfView.fromStream(inputStream)
                ...
                .onPageChange(PdfguideActivity.this)//监听页面切换
